...
class Mysql {
    ...
    find(name, execTree, indexFrom, count, isCounting, con, forceIndex, useCache, cacheExpiredTime) {
    ...
    disableStorageBy(entity, id) {
        return this.mtStorage.clearStorageBy(entity, id)
    }
